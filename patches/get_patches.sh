...
# patches from Alpine for gcc 10.3.1

for p in 0001-posix_memalign.patch 0002-gcc-poison-system-directories.patch \
...
do
    wget https://github.com/alpinelinux/aports/raw/master/main/gcc/$p
done
